...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $data['start'] = strval($request->input('start')) +     '00:00:00';
        // $data['end'] = strval($request->input('end')) +     '00:00:00';
    ...
    public function modali(Request $request, $id)
    {
        ...
        $transaksi->users_id = $request->input('user_id');
        $transaksi->projects_id = $request->input('project_id');

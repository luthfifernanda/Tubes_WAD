    ...
    <div class="container">
        ...
        <div class="row pt-5">
            <div class="col-4">
                ...
                <h1 class="text-center" style="color:#363636;">Mulai Suksesmu dengan Kopii.id</h1>
            ...
            <div class="col kanan" style="height:500px;">
                <form method="post" action="{{route('project.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row" style="color: black;">
                        <label for="jenis_kopi" class="col-sm-4 col-form-label col-form-label-sm">Jenis Kopi</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="jenis_cabai" placeholder="Jenis kopi" name="jenis_kopi">
                        </div>
                    </div>
                    <div class="form-group row" style="color: black;">
                        <label for="no_project" class="col-sm-4 col-form-label col-form-label-sm">No Project</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="no_project" placeholder="Jenis kopi" name="no_project">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="color: black;">
                        <label for="periode" class="col-sm-4 col-form-label col-form-label-sm">Periode</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="periode" placeholder="Masukkan jumlah petani" name="periode">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="color: black;">
                        <label for="skema" class="col-sm-4 col-form-label col-form-label-sm">Skema</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="skema" placeholder="Masukkan luas lahan" name="skema">
                        </div>
                    </div>
